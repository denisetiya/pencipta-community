-- CreateEnum
CREATE TYPE "ProfileStatus" AS ENUM ('ACTIVE', 'HIDDEN');

-- CreateEnum
CREATE TYPE "ProfileSource" AS ENUM ('AI_GENERATED', 'SELF_ADDED');
...
CREATE TABLE "Profile" (
    ...
    "source" "ProfileSource" NOT NULL DEFAULT 'AI_GENERATED',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
